...
export const execute = async (interaction: CommandInteraction) => {
  ...
  switch (command) {
    case "roll":
      ...
      Optional Inputs:
      If you have any assistance, you will have to enter the number of characters giving unskilled or skilled assist separately. If you spent a voidpent, select True for voidpoint.
      You may also enter the TN if you would like it displayed, as well as give the roll a label such as "Saburo's Tea Ceremony Check". To remove an optional category you did not mean to use, you can backspace to remove it.
      ...
      You can keep 2 dice since the used Ring was 2. If you wanted to keep ${DISCORD_DIE_EMOJI.D6[6]}${DISCORD_DIE_EMOJI.D12[6]} then you need to keep the 2nd and 3rd die. To do this, click Keep under the roll and then enter "2 3" or "2,3" and you will keep the second and third dice.
      Using this method you can keep any number of dice up to the limit allowed for your roll based on Ring dice, assists, and void points spent. If you try to keep more than you are allowed, they are kept in order from left to right until you can't keep dice anymore.  
      ...
      🤝🏽 - Assistance (1 per assist)
      🌀 - Void point spent
      🪭 - A bonus rolled or kept die was added (1 per added die)
      💢 - An explosive was kept
      ⤵️ - A dice was set to a specific result
      🔁 - Rerolls are tracked separately, used for advantages or disadvantages.
      `;
      break;
    case "symbols":
